        ...
        <div class="table">
            ...
            <table id="myTable">
                ...
                <tr>
                    ...
                    <th onclick="sortTable(3)" class="t-seller">Buyer <span class="iconic"><i class="fas fa-sort"></i></span></th>
        ...
        <div class="table">
            ...
            <table id="myTable2">
                ...
                <tr>
                    ...
                    <th onclick="sortTable2(3)" class="t-seller">Buyer <span class="iconic"><i class="fas fa-sort"></i></span></th>
                    <th onclick="sortTable2(4)" class="t-date">Date <span class="iconic"><i class="fas fa-sort"></i></span></th>
                </tr>
                
                <tr>
                    <td class="t-product">Rice (sold in bags)</td>
                    <td class="t-quant">10</td>
                    <td class="t-price">34,6000</td>
                ...
                <tr>
                    ...
                    <td class="t-price">134,600</td>
                    <td class="t-seller">Beriko</td>
                    <td class="t-date">17 / 11 / 22</td>
                </tr>

                <tr>
                    <td class="t-product">Beans (sold in bags)</td>
                    <td class="t-quant">2</td>
                    <td class="t-price">24,000</td>
                    <td class="t-seller">Samuel</td>
                    <td class="t-date">12 / 10 / 22</td>
                </tr>
